...
from pywebio.output import put_text, put_code, put_processbar
...
class WebTest:
    def __init__(self):
        self.pages_for_test = self.choose_pages()
        ...
        self.observer_thread = threading.Thread(target=observe_test, args=(*self.data_share,self.test_thread))
    ...
    def choose_pages(self):
        pages_list = TestUtility.get_he_pages()
