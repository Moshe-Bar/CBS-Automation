...
URL = r"https://www.cbs.gov.il/he/subjects/Pages/%D7%90%D7%95%D7%9B%D7%9C%D7%95%D7%A1%D7%99%D7%99%D7%94-%D7%91%D7%99%D7%99%D7%A9%D7%95%D7%91%D7%99%D7%9D.aspx"

sess = TestUtility.create_web_driver()
...
xpath = ROOT_ELEMENT + XPATH['RIGHT_EXTRA_PARTS_XPATH']
...
#     # WebPartUtility.set_heb_statistical(page=page, session=sess)
    element = WebDriverWait(sess, 10).until(EC.presence_of_element_located((By.XPATH, ROOT_ELEMENT)))
