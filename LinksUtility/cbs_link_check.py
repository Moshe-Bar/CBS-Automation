...
# driver.get('https://www.cbs.gov.il/he/subjects/Pages/%D7%90%D7%95%D7%A1%D7%99%D7%99%D7%94.aspx')
# text = []
# for error_string in BUILT_ERROR_MASSAGE:
#     text.append(driver.find_elements_by_xpath("//*[contains(text(),'{}')]".format(error_string)))
# if not len(text) == 0:
#     print('error page ')
# driver.close()
